...
export const BRAIN_PROVIDERS = {
  claude: {
    ...
    active: true,
    models: [
      { id: 'opus', name: 'Opus', desc: 'Most capable. Complex reasoning, architecture.', tier: 'premium', color: '#D97706' },
      { id: 'sonnet', name: 'Sonnet', desc: 'Balanced. Great for most tasks.', tier: 'standard', color: '#3B82F6' },
      { id: 'haiku', name: 'Haiku', desc: 'Fastest. Quick checks, simple tasks.', tier: 'economy', color: '#22C55E' },
    ],
  },
  ollama: {
    name: 'Ollama (Local)',
...
export function getModelDisplay(brain) {
  ...
  if (!model) return { name: 'Opus', color: '#D97706', tier: 'premium' };
